...
HD_PWD='C:/Users/Saurav Kumar/Uart_Reciever/Uart_Reciever.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_Reciever.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Uart_Reciever.tcl -notrace
