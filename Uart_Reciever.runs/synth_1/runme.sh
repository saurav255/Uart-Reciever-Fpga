...
HD_PWD='C:/Users/Saurav Kumar/Uart_Reciever/Uart_Reciever.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_Reciever.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uart_Reciever.tcl
